...
- There are two types of top hinges:
  ...
  - `Hinge_Top_With_Backstop_Left.stl` adds a reasonably sturdy backstop that allows the top to open 125°, but has a bit of flex. Print this one twice, with one mirrored.
